...
public class DetailUjianActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tvDet4.setText("Tanggal : "+intent.getStringExtra(Config.TAG_TGL));
        tvDet5.setText("Jam Mulai : "+intent.getStringExtra(Config.TAG_JAM_MULAI));
        tvDet6.setText("Jam Selesai : "+intent.getStringExtra(Config.TAG_JAM_SELESAI));
        tvDet7.setText("Keterangan :" +intent.getStringExtra(Config.TAG_KET));
    }
