...
public class PilihSiswaActivity extends AppCompatActivity  implements ListView.OnItemClickListener  {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        pdModel.pdMenyiapkanDataJadwal(PilihSiswaActivity.this);
        ...
        StringRequest request = new StringRequest(uri,
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        SiswaAdapter adapter = new SiswaAdapter(PilihSiswaActivity.this, siswaList);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(PilihSiswaActivity.this, error.getMessage().toString(), Toast.LENGTH_SHORT).show();
                        pdModel.hideProgressDialog();
                    }
                });
