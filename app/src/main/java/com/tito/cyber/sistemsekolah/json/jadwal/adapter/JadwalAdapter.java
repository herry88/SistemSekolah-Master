package com.tito.cyber.sistemsekolah.json.jadwal.adapter;
...
public class JadwalAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if(convertView == null) {
            ...
            holder._namaGuru = (TextView) convertView.findViewById(R.id.tv3);
            holder._kelas = (TextView) convertView.findViewById(R.id.tv4);
            holder._sub_kelas = (TextView) convertView.findViewById(R.id.tv5);
            holder._mapel = (TextView) convertView.findViewById(R.id.tv1);
            holder._hari=(TextView)convertView.findViewById(R.id.tv2);
            holder._jam_mulai = (TextView) convertView.findViewById(R.id.tv6);
            holder._jam_selesai = (TextView) convertView.findViewById(R.id.tv7);
